...
class IDeckLinkVideoOutputCallback_v7_6 : public IUnknown {
 ...
 protected:
  virtual ~IDeckLinkVideoOutputCallback_v7_6(){};  // call Release method to
...
class IDeckLinkInputCallback_v7_6 : public IUnknown {
 ...
 protected:
  virtual ~IDeckLinkInputCallback_v7_6(){};  // call Release method to drop
                                             // reference count
};

/* Interface IDeckLinkDisplayModeIterator - enumerates over supported
...
class IDeckLinkDisplayModeIterator_v7_6 : public IUnknown {
 ...
 protected:
  virtual ~IDeckLinkDisplayModeIterator_v7_6(){};  // call Release method to
                                                   // drop reference count
};
...
class IDeckLinkDisplayMode_v7_6 : public IUnknown {
 public:
  ...
  virtual HRESULT GetFrameRate(/* out */ BMDTimeValue* frameDuration,
                               /* out */ BMDTimeScale* timeScale) = 0;
  virtual BMDFieldDominance GetFieldDominance(void) = 0;

 protected:
  virtual ~IDeckLinkDisplayMode_v7_6(){};  // call Release method to drop
                                           // reference count
};
...
class IDeckLinkOutput_v7_6 : public IUnknown {
 public:
  ...
  virtual HRESULT ScheduleVideoFrame(
 ...
 protected:
  virtual ~IDeckLinkOutput_v7_6(){};  // call Release method to drop reference
                                      // count
};
...
class IDeckLinkInput_v7_6 : public IUnknown {
 ...
 protected:
  virtual ~IDeckLinkInput_v7_6(){};  // call Release method to drop reference
                                     // count
};
...
class IDeckLinkTimecode_v7_6 : public IUnknown {
 ...
 protected:
  virtual ~IDeckLinkTimecode_v7_6(){};  // call Release method to drop reference
                                        // count
};
...
class IDeckLinkVideoFrame_v7_6 : public IUnknown {
 ...
 protected:
  virtual ~IDeckLinkVideoFrame_v7_6(){};  // call Release method to drop
                                          // reference count
};
...
class IDeckLinkMutableVideoFrame_v7_6 : public IDeckLinkVideoFrame_v7_6 {
 public:
  ...
  virtual HRESULT SetTimecode(BMDTimecodeFormat format,
 ...
 protected:
  virtual ~IDeckLinkMutableVideoFrame_v7_6(){};  // call Release method to drop
                                                 // reference count
};
...
class IDeckLinkVideoInputFrame_v7_6 : public IDeckLinkVideoFrame_v7_6 {
 ...
 protected:
  virtual ~IDeckLinkVideoInputFrame_v7_6(){};  // call Release method to drop
                                               // reference count
};
...
class IDeckLinkScreenPreviewCallback_v7_6 : public IUnknown {
 ...
 protected:
  virtual ~IDeckLinkScreenPreviewCallback_v7_6(){};  // call Release method to
                                                     // drop reference count
};
...
class IDeckLinkGLScreenPreviewHelper_v7_6 : public IUnknown {
 ...
 protected:
  virtual ~IDeckLinkGLScreenPreviewHelper_v7_6(){};  // call Release method to
                                                     // drop reference count
};
...
class IDeckLinkVideoConversion_v7_6 : public IUnknown {
 ...
 protected:
  virtual ~IDeckLinkVideoConversion_v7_6(){};  // call Release method to drop
                                               // reference count
};
...
class IDeckLinkConfiguration_v7_6 : public IUnknown {
 public:
  virtual HRESULT GetConfigurationValidator(
      /* out */ IDeckLinkConfiguration_v7_6** configObject) = 0;
  virtual HRESULT WriteConfigurationToPreferences(void) = 0;

  /* Video Output Configuration */

  virtual HRESULT SetVideoOutputFormat(
      /* in */ BMDVideoConnection_v7_6 videoOutputConnection) = 0;
  virtual HRESULT IsVideoOutputActive(
      /* in */ BMDVideoConnection_v7_6 videoOutputConnection,
      /* out */ bool* active) = 0;

  virtual HRESULT SetAnalogVideoOutputFlags(
      /* in */ BMDAnalogVideoFlags analogVideoFlags) = 0;
  virtual HRESULT GetAnalogVideoOutputFlags(
      /* out */ BMDAnalogVideoFlags* analogVideoFlags) = 0;

  virtual HRESULT EnableFieldFlickerRemovalWhenPaused(/* in */ bool enable) = 0;
  virtual HRESULT IsEnabledFieldFlickerRemovalWhenPaused(
      /* out */ bool* enabled) = 0;

  virtual HRESULT Set444And3GBpsVideoOutput(/* in */ bool enable444VideoOutput,
                                            /* in */ bool enable3GbsOutput) = 0;
  virtual HRESULT Get444And3GBpsVideoOutput(
      /* out */ bool* is444VideoOutputEnabled,
      /* out */ bool* threeGbsOutputEnabled) = 0;

  virtual HRESULT SetVideoOutputConversionMode(
      /* in */ BMDVideoOutputConversionMode conversionMode) = 0;
  virtual HRESULT GetVideoOutputConversionMode(
      /* out */ BMDVideoOutputConversionMode* conversionMode) = 0;

  virtual HRESULT Set_HD1080p24_to_HD1080i5994_Conversion(
      /* in */ bool enable) = 0;
  virtual HRESULT Get_HD1080p24_to_HD1080i5994_Conversion(
      /* out */ bool* enabled) = 0;

  /* Video Input Configuration */

  virtual HRESULT SetVideoInputFormat(
      /* in */ BMDVideoConnection_v7_6 videoInputFormat) = 0;
  virtual HRESULT GetVideoInputFormat(
      /* out */ BMDVideoConnection_v7_6* videoInputFormat) = 0;

  virtual HRESULT SetAnalogVideoInputFlags(
      /* in */ BMDAnalogVideoFlags analogVideoFlags) = 0;
  virtual HRESULT GetAnalogVideoInputFlags(
      /* out */ BMDAnalogVideoFlags* analogVideoFlags) = 0;

  virtual HRESULT SetVideoInputConversionMode(
      /* in */ BMDVideoInputConversionMode conversionMode) = 0;
  virtual HRESULT GetVideoInputConversionMode(
      /* out */ BMDVideoInputConversionMode* conversionMode) = 0;

  virtual HRESULT SetBlackVideoOutputDuringCapture(
      /* in */ bool blackOutInCapture) = 0;
  virtual HRESULT GetBlackVideoOutputDuringCapture(
      /* out */ bool* blackOutInCapture) = 0;

  virtual HRESULT Set32PulldownSequenceInitialTimecodeFrame(
      /* in */ uint32_t aFrameTimecode) = 0;
  virtual HRESULT Get32PulldownSequenceInitialTimecodeFrame(
      /* out */ uint32_t* aFrameTimecode) = 0;

  virtual HRESULT SetVancSourceLineMapping(
      /* in */ uint32_t activeLine1VANCsource,
      /* in */ uint32_t activeLine2VANCsource,
      /* in */ uint32_t activeLine3VANCsource) = 0;
  virtual HRESULT GetVancSourceLineMapping(
      /* out */ uint32_t* activeLine1VANCsource,
      /* out */ uint32_t* activeLine2VANCsource,
      /* out */ uint32_t* activeLine3VANCsource) = 0;

  /* Audio Input Configuration */

  virtual HRESULT SetAudioInputFormat(
      /* in */ BMDAudioConnection audioInputFormat) = 0;
  virtual HRESULT GetAudioInputFormat(
