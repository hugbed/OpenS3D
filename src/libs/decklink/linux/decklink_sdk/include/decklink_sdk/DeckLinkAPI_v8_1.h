...
#define IID_IDeckLinkDeckControlStatusCallback_v8_1 /* E5F693C1-4283-4716-B18F-C1431521955B \
                                                       */                                   \
  (REFIID) {                                                                                \
    0xE5, 0xF6, 0x93, 0xC1, 0x42, 0x83, 0x47, 0x16, 0xB1, 0x8F, 0xC1, 0x43,                 \
        0x15, 0x21, 0x95, 0x5B                                                              \
  }
#define IID_IDeckLinkDeckControl_v8_1 /* 522A9E39-0F3C-4742-94EE-D80DE335DA1D \
                                         */                                   \
  (REFIID) {                                                                  \
    0x52, 0x2A, 0x9E, 0x39, 0x0F, 0x3C, 0x47, 0x42, 0x94, 0xEE, 0xD8, 0x0D,   \
        0xE3, 0x35, 0xDA, 0x1D                                                \
  }
...
/* Interface IDeckLinkDeckControlStatusCallback_v8_1 - Deck control state change
 * callback. */
...
class IDeckLinkDeckControlStatusCallback_v8_1 : public IUnknown {
 ...
 protected:
  virtual ~IDeckLinkDeckControlStatusCallback_v8_1(){};  // call Release method
                                                         // to drop reference
                                                         // count
};
...
class IDeckLinkDeckControl_v8_1 : public IUnknown {
 ...
 protected:
  virtual ~IDeckLinkDeckControl_v8_1(){};  // call Release method to drop
                                           // reference count
};
