...
constexpr BMD_CONST REFIID IID_IDeckLinkConfiguration =
    /* CB71734A-FE37-4E8D-8E13-802133A1C3F2 */ {
        0xCB, 0x71, 0x73, 0x4A, 0xFE, 0x37, 0x4E, 0x8D,
        0x8E, 0x13, 0x80, 0x21, 0x33, 0xA1, 0xC3, 0xF2};
constexpr BMD_CONST REFIID IID_IDeckLinkEncoderConfiguration =
    /* 138050E5-C60A-4552-BF3F-0F358049327E */ {
        0x13, 0x80, 0x50, 0xE5, 0xC6, 0x0A, 0x45, 0x52,
        0xBF, 0x3F, 0x0F, 0x35, 0x80, 0x49, 0x32, 0x7E};
...
enum _BMDDeckLinkConfigurationID {
  ...
  bmdDeckLinkConfigVideoInputScanning =
      /* 'visc' */ 0x76697363,  // Applicable to H264 Pro Recorder only
  bmdDeckLinkConfigUseDedicatedLTCInput =
      /* 'dltc' */ 0x646C7463,  // Use timecode from LTC input instead of SDI
                                // stream
...
enum _BMDDeckLinkEncoderConfigurationID {
  ...
  bmdDeckLinkEncoderConfigMPEG4SampleDescription =
      /* 'stsE' */ 0x73747345,  // Full MPEG4 sample description (aka
                                // SampleEntry of an 'stsd' atom-box). Useful
                                // for MediaFoundation, QuickTime, MKV and more
  bmdDeckLinkEncoderConfigMPEG4CodecSpecificDesc =
      /* 'esds' */ 0x65736473  // Sample description extensions only (atom
                               // stream, each with size and fourCC header).
                               // Useful for AVFoundation, VideoToolbox, MKV and
                               // more
};
...
/* Interface IDeckLinkEncoderConfiguration - DeckLink Encoder Configuration
 * interface. Obtained from IDeckLinkEncoderInput */

class IDeckLinkEncoderConfiguration : public IUnknown {
 public:
  virtual HRESULT SetFlag(/* in */ BMDDeckLinkEncoderConfigurationID cfgID,
                          /* in */ bool value) = 0;
  virtual HRESULT GetFlag(/* in */ BMDDeckLinkEncoderConfigurationID cfgID,
                          /* out */ bool* value) = 0;
  virtual HRESULT SetInt(/* in */ BMDDeckLinkEncoderConfigurationID cfgID,
                         /* in */ int64_t value) = 0;
  virtual HRESULT GetInt(/* in */ BMDDeckLinkEncoderConfigurationID cfgID,
                         /* out */ int64_t* value) = 0;
  virtual HRESULT SetFloat(/* in */ BMDDeckLinkEncoderConfigurationID cfgID,
                           /* in */ double value) = 0;
  virtual HRESULT GetFloat(/* in */ BMDDeckLinkEncoderConfigurationID cfgID,
                           /* out */ double* value) = 0;
  virtual HRESULT SetString(/* in */ BMDDeckLinkEncoderConfigurationID cfgID,
                            /* in */ const char* value) = 0;
  virtual HRESULT GetString(/* in */ BMDDeckLinkEncoderConfigurationID cfgID,
                            /* out */ const char** value) = 0;
  virtual HRESULT GetBytes(/* in */ BMDDeckLinkEncoderConfigurationID cfgID,
