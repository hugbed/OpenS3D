...
constexpr BMD_CONST REFIID IID_IDeckLinkVideoOutputCallback =
    /* 20AA5225-1958-47CB-820B-80A8D521A6EE */ {0x20, 0xAA, 0x52, 0x25, 0x19, 0x58, 0x47, 0xCB,
                                                0x82, 0x0B, 0x80, 0xA8, 0xD5, 0x21, 0xA6, 0xEE};
constexpr BMD_CONST REFIID IID_IDeckLinkInputCallback =
    /* DD04E5EC-7415-42AB-AE4A-E80C4DFC044A */ {0xDD, 0x04, 0xE5, 0xEC, 0x74, 0x15, 0x42, 0xAB,
                                                0xAE, 0x4A, 0xE8, 0x0C, 0x4D, 0xFC, 0x04, 0x4A};
constexpr BMD_CONST REFIID IID_IDeckLinkEncoderInputCallback =
    /* ACF13E61-F4A0-4974-A6A7-59AFF6268B31 */ {0xAC, 0xF1, 0x3E, 0x61, 0xF4, 0xA0, 0x49, 0x74,
                                                0xA6, 0xA7, 0x59, 0xAF, 0xF6, 0x26, 0x8B, 0x31};
constexpr BMD_CONST REFIID IID_IDeckLinkMemoryAllocator =
    /* B36EB6E7-9D29-4AA8-92EF-843B87A289E8 */ {0xB3, 0x6E, 0xB6, 0xE7, 0x9D, 0x29, 0x4A, 0xA8,
                                                0x92, 0xEF, 0x84, 0x3B, 0x87, 0xA2, 0x89, 0xE8};
constexpr BMD_CONST REFIID IID_IDeckLinkAudioOutputCallback =
    /* 403C681B-7F46-4A12-B993-2BB127084EE6 */ {0x40, 0x3C, 0x68, 0x1B, 0x7F, 0x46, 0x4A, 0x12,
                                                0xB9, 0x93, 0x2B, 0xB1, 0x27, 0x08, 0x4E, 0xE6};
constexpr BMD_CONST REFIID IID_IDeckLinkIterator =
    /* 50FB36CD-3063-4B73-BDBB-958087F2D8BA */ {0x50, 0xFB, 0x36, 0xCD, 0x30, 0x63, 0x4B, 0x73,
                                                0xBD, 0xBB, 0x95, 0x80, 0x87, 0xF2, 0xD8, 0xBA};
constexpr BMD_CONST REFIID IID_IDeckLinkAPIInformation =
    /* 7BEA3C68-730D-4322-AF34-8A7152B532A4 */ {0x7B, 0xEA, 0x3C, 0x68, 0x73, 0x0D, 0x43, 0x22,
                                                0xAF, 0x34, 0x8A, 0x71, 0x52, 0xB5, 0x32, 0xA4};
constexpr BMD_CONST REFIID IID_IDeckLinkOutput =
    /* CC5C8A6E-3F2F-4B3A-87EA-FD78AF300564 */ {0xCC, 0x5C, 0x8A, 0x6E, 0x3F, 0x2F, 0x4B, 0x3A,
                                                0x87, 0xEA, 0xFD, 0x78, 0xAF, 0x30, 0x05, 0x64};
constexpr BMD_CONST REFIID IID_IDeckLinkInput =
    /* AF22762B-DFAC-4846-AA79-FA8883560995 */ {0xAF, 0x22, 0x76, 0x2B, 0xDF, 0xAC, 0x48, 0x46,
                                                0xAA, 0x79, 0xFA, 0x88, 0x83, 0x56, 0x09, 0x95};
constexpr BMD_CONST REFIID IID_IDeckLinkEncoderInput =
    /* 270587DA-6B7D-42E7-A1F0-6D853F581185 */ {0x27, 0x05, 0x87, 0xDA, 0x6B, 0x7D, 0x42, 0xE7,
                                                0xA1, 0xF0, 0x6D, 0x85, 0x3F, 0x58, 0x11, 0x85};
constexpr BMD_CONST REFIID IID_IDeckLinkVideoFrame =
    /* 3F716FE0-F023-4111-BE5D-EF4414C05B17 */ {0x3F, 0x71, 0x6F, 0xE0, 0xF0, 0x23, 0x41, 0x11,
                                                0xBE, 0x5D, 0xEF, 0x44, 0x14, 0xC0, 0x5B, 0x17};
constexpr BMD_CONST REFIID IID_IDeckLinkMutableVideoFrame =
    /* 69E2639F-40DA-4E19-B6F2-20ACE815C390 */ {0x69, 0xE2, 0x63, 0x9F, 0x40, 0xDA, 0x4E, 0x19,
                                                0xB6, 0xF2, 0x20, 0xAC, 0xE8, 0x15, 0xC3, 0x90};
constexpr BMD_CONST REFIID IID_IDeckLinkVideoFrame3DExtensions =
    /* DA0F7E4A-EDC7-48A8-9CDD-2DB51C729CD7 */ {0xDA, 0x0F, 0x7E, 0x4A, 0xED, 0xC7, 0x48, 0xA8,
                                                0x9C, 0xDD, 0x2D, 0xB5, 0x1C, 0x72, 0x9C, 0xD7};
constexpr BMD_CONST REFIID IID_IDeckLinkVideoFrameMetadataExtensions =
    /* D5973DC9-6432-46D0-8F0B-2496F8A1238F */ {0xD5, 0x97, 0x3D, 0xC9, 0x64, 0x32, 0x46, 0xD0,
                                                0x8F, 0x0B, 0x24, 0x96, 0xF8, 0xA1, 0x23, 0x8F};
constexpr BMD_CONST REFIID IID_IDeckLinkVideoInputFrame =
    /* 05CFE374-537C-4094-9A57-680525118F44 */ {0x05, 0xCF, 0xE3, 0x74, 0x53, 0x7C, 0x40, 0x94,
                                                0x9A, 0x57, 0x68, 0x05, 0x25, 0x11, 0x8F, 0x44};
constexpr BMD_CONST REFIID IID_IDeckLinkVideoFrameAncillary =
    /* 732E723C-D1A4-4E29-9E8E-4A88797A0004 */ {0x73, 0x2E, 0x72, 0x3C, 0xD1, 0xA4, 0x4E, 0x29,
                                                0x9E, 0x8E, 0x4A, 0x88, 0x79, 0x7A, 0x00, 0x04};
constexpr BMD_CONST REFIID IID_IDeckLinkEncoderPacket =
    /* B693F36C-316E-4AF1-B6C2-F389A4BCA620 */ {0xB6, 0x93, 0xF3, 0x6C, 0x31, 0x6E, 0x4A, 0xF1,
                                                0xB6, 0xC2, 0xF3, 0x89, 0xA4, 0xBC, 0xA6, 0x20};
constexpr BMD_CONST REFIID IID_IDeckLinkEncoderVideoPacket =
    /* 4E7FD944-E8C7-4EAC-B8C0-7B77F80F5AE0 */ {0x4E, 0x7F, 0xD9, 0x44, 0xE8, 0xC7, 0x4E, 0xAC,
                                                0xB8, 0xC0, 0x7B, 0x77, 0xF8, 0x0F, 0x5A, 0xE0};
constexpr BMD_CONST REFIID IID_IDeckLinkEncoderAudioPacket =
    /* 49E8EDC8-693B-4E14-8EF6-12C658F5A07A */ {0x49, 0xE8, 0xED, 0xC8, 0x69, 0x3B, 0x4E, 0x14,
                                                0x8E, 0xF6, 0x12, 0xC6, 0x58, 0xF5, 0xA0, 0x7A};
constexpr BMD_CONST REFIID IID_IDeckLinkH265NALPacket =
    /* 639C8E0B-68D5-4BDE-A6D4-95F3AEAFF2E7 */ {0x63, 0x9C, 0x8E, 0x0B, 0x68, 0xD5, 0x4B, 0xDE,
                                                0xA6, 0xD4, 0x95, 0xF3, 0xAE, 0xAF, 0xF2, 0xE7};
constexpr BMD_CONST REFIID IID_IDeckLinkAudioInputPacket =
    /* E43D5870-2894-11DE-8C30-0800200C9A66 */ {0xE4, 0x3D, 0x58, 0x70, 0x28, 0x94, 0x11, 0xDE,
                                                0x8C, 0x30, 0x08, 0x00, 0x20, 0x0C, 0x9A, 0x66};
constexpr BMD_CONST REFIID IID_IDeckLinkScreenPreviewCallback =
    /* B1D3F49A-85FE-4C5D-95C8-0B5D5DCCD438 */ {0xB1, 0xD3, 0xF4, 0x9A, 0x85, 0xFE, 0x4C, 0x5D,
                                                0x95, 0xC8, 0x0B, 0x5D, 0x5D, 0xCC, 0xD4, 0x38};
constexpr BMD_CONST REFIID IID_IDeckLinkGLScreenPreviewHelper =
    /* 504E2209-CAC7-4C1A-9FB4-C5BB6274D22F */ {0x50, 0x4E, 0x22, 0x09, 0xCA, 0xC7, 0x4C, 0x1A,
                                                0x9F, 0xB4, 0xC5, 0xBB, 0x62, 0x74, 0xD2, 0x2F};
constexpr BMD_CONST REFIID IID_IDeckLinkNotificationCallback =
    /* B002A1EC-070D-4288-8289-BD5D36E5FF0D */ {0xB0, 0x02, 0xA1, 0xEC, 0x07, 0x0D, 0x42, 0x88,
                                                0x82, 0x89, 0xBD, 0x5D, 0x36, 0xE5, 0xFF, 0x0D};
constexpr BMD_CONST REFIID IID_IDeckLinkNotification =
    /* 0A1FB207-E215-441B-9B19-6FA1575946C5 */ {0x0A, 0x1F, 0xB2, 0x07, 0xE2, 0x15, 0x44, 0x1B,
                                                0x9B, 0x19, 0x6F, 0xA1, 0x57, 0x59, 0x46, 0xC5};
constexpr BMD_CONST REFIID IID_IDeckLinkAttributes =
    /* ABC11843-D966-44CB-96E2-A1CB5D3135C4 */ {0xAB, 0xC1, 0x18, 0x43, 0xD9, 0x66, 0x44, 0xCB,
                                                0x96, 0xE2, 0xA1, 0xCB, 0x5D, 0x31, 0x35, 0xC4};
constexpr BMD_CONST REFIID IID_IDeckLinkStatus =
    /* 5F558200-4028-49BC-BEAC-DB3FA4A96E46 */ {0x5F, 0x55, 0x82, 0x00, 0x40, 0x28, 0x49, 0xBC,
                                                0xBE, 0xAC, 0xDB, 0x3F, 0xA4, 0xA9, 0x6E, 0x46};
constexpr BMD_CONST REFIID IID_IDeckLinkKeyer =
    /* 89AFCAF5-65F8-421E-98F7-96FE5F5BFBA3 */ {0x89, 0xAF, 0xCA, 0xF5, 0x65, 0xF8, 0x42, 0x1E,
                                                0x98, 0xF7, 0x96, 0xFE, 0x5F, 0x5B, 0xFB, 0xA3};
constexpr BMD_CONST REFIID IID_IDeckLinkVideoConversion =
    /* 3BBCB8A2-DA2C-42D9-B5D8-88083644E99A */ {0x3B, 0xBC, 0xB8, 0xA2, 0xDA, 0x2C, 0x42, 0xD9,
                                                0xB5, 0xD8, 0x88, 0x08, 0x36, 0x44, 0xE9, 0x9A};
constexpr BMD_CONST REFIID IID_IDeckLinkDeviceNotificationCallback =
    /* 4997053B-0ADF-4CC8-AC70-7A50C4BE728F */ {0x49, 0x97, 0x05, 0x3B, 0x0A, 0xDF, 0x4C, 0xC8,
                                                0xAC, 0x70, 0x7A, 0x50, 0xC4, 0xBE, 0x72, 0x8F};
constexpr BMD_CONST REFIID IID_IDeckLinkDiscovery =
    /* CDBF631C-BC76-45FA-B44D-C55059BC6101 */ {0xCD, 0xBF, 0x63, 0x1C, 0xBC, 0x76, 0x45, 0xFA,
                                                0xB4, 0x4D, 0xC5, 0x50, 0x59, 0xBC, 0x61, 0x01};

/* Enum BMDVideoOutputFlags - Flags to control the output of ancillary data
 * along with video. */
...
enum _BMDPacketType {
  bmdPacketTypeStreamInterruptedMarker =
      /* 'sint' */ 0x73696E74,                       // A packet of this type marks the time when a
                                                     // video stream was interrupted, for example by
...
/* Enum BMDVideoInputFormatChangedEvents - Bitmask passed to the
 * VideoInputFormatChanged notification to identify the properties of the input
 * signal that have changed */
...
/* Enum BMDDetectedVideoInputFormatFlags - Flags passed to the
 * VideoInputFormatChanged notification to describe the detected video input
 * signal */
...
/* Enum BMDDeckLinkCapturePassthroughMode - Enumerates whether the video output
 * is electrically connected to the video input or if the clean switching mode
 * is enabled */
...
enum _BMDAudioSampleRate { bmdAudioSampleRate48kHz = 48000 };
...
enum _BMDTimecodeFormat {
  bmdTimecodeRP188VITC1 = /* 'rpv1' */ 0x72707631,  // RP188 timecode where DBB1
                                                    // equals VITC1 (line 9)
  bmdTimecodeRP188VITC2 = /* 'rp12' */ 0x72703132,  // RP188 timecode where DBB1
                                                    // equals VITC2 (line 9 for
                                                    // progressive or line 571
                                                    // for interlaced/PsF)
  bmdTimecodeRP188LTC = /* 'rplt' */ 0x72706C74,    // RP188 timecode where DBB1
                                                    // equals LTC (line 10)
  bmdTimecodeRP188Any =
      /* 'rp18' */ 0x72703138,  // For capture: return the first valid timecode
                                // in {VITC1, LTC ,VITC2} - For playback: set
                                // the timecode as VITC1
...
/* Enum BMDIdleVideoOutputOperation - Video output operation when not playing
 * video */
...
enum _BMDDeckLinkFrameMetadataID {
  bmdDeckLinkFrameMetadataHDRElectroOpticalTransferFunc =
      /* 'eotf' */ 0x656F7466,  // EOTF in range 0-7 as per CEA 861.3
  bmdDeckLinkFrameMetadataHDRDisplayPrimariesRedX =
      /* 'hdrx' */ 0x68647278,  // Red display primaries in range 0.0 - 1.0
  bmdDeckLinkFrameMetadataHDRDisplayPrimariesRedY =
      /* 'hdry' */ 0x68647279,  // Red display primaries in range 0.0 - 1.0
  bmdDeckLinkFrameMetadataHDRDisplayPrimariesGreenX =
      /* 'hdgx' */ 0x68646778,  // Green display primaries in range 0.0 - 1.0
  bmdDeckLinkFrameMetadataHDRDisplayPrimariesGreenY =
      /* 'hdgy' */ 0x68646779,  // Green display primaries in range 0.0 - 1.0
  bmdDeckLinkFrameMetadataHDRDisplayPrimariesBlueX =
      /* 'hdbx' */ 0x68646278,  // Blue display primaries in range 0.0 - 1.0
  bmdDeckLinkFrameMetadataHDRDisplayPrimariesBlueY =
      /* 'hdby' */ 0x68646279,  // Blue display primaries in range 0.0 - 1.0
  bmdDeckLinkFrameMetadataHDRWhitePointX =
      /* 'hdwx' */ 0x68647778,  // White point in range 0.0 - 1.0
  bmdDeckLinkFrameMetadataHDRWhitePointY =
      /* 'hdwy' */ 0x68647779,  // White point in range 0.0 - 1.0
  bmdDeckLinkFrameMetadataHDRMaxDisplayMasteringLuminance =
      /* 'hdml' */ 0x68646D6C,  // Max display mastering luminance in range 1
                                // cd/m2 - 65535 cd/m2
  bmdDeckLinkFrameMetadataHDRMinDisplayMasteringLuminance =
      /* 'hmil' */ 0x686D696C,  // Min display mastering luminance in range
                                // 0.0001 cd/m2 - 6.5535 cd/m2
  bmdDeckLinkFrameMetadataHDRMaximumContentLightLevel =
      /* 'mcll' */ 0x6D636C6C,  // Maximum Content Light Level in range 1 cd/m2
                                // - 65535 cd/m2
  bmdDeckLinkFrameMetadataHDRMaximumFrameAverageLightLevel =
      /* 'fall' */ 0x66616C6C  // Maximum Frame Average Light Level in range 1
                               // cd/m2 - 65535 cd/m2
};
...
enum _BMDDeckLinkAttributeID {
  ...
  BMDDeckLinkVideoIOSupport =
      /* 'vios' */ 0x76696F73,  // Returns a BMDVideoIOSupport bit field
  BMDDeckLinkDeckControlConnections = /* 'dccn' */ 0x6463636E,
  BMDDeckLinkDeviceInterface =
      /* 'dbus' */ 0x64627573,  // Returns a BMDDeviceInterface
...
enum _BMDDeckLinkAPIInformationID { BMDDeckLinkAPIVersion = /* 'vers' */ 0x76657273 };
...
enum _BMDVideoIOSupport { bmdDeviceSupportsCapture = 1 << 0, bmdDeviceSupportsPlayback = 1 << 1 };
...
/* Enum BMDNotifications - Events that can be subscribed through
...
class IDeckLinkEncoderInputCallback : public IUnknown {
 public:
  virtual HRESULT VideoInputSignalChanged(
      /* in */ BMDVideoInputFormatChangedEvents notificationEvents,
      /* in */ IDeckLinkDisplayMode* newDisplayMode,
      /* in */ BMDDetectedVideoInputFormatFlags detectedSignalFlags) = 0;
  virtual HRESULT VideoPacketArrived(
      /* in */ IDeckLinkEncoderVideoPacket* videoPacket) = 0;
  virtual HRESULT AudioPacketArrived(
...
class IDeckLinkMemoryAllocator : public IUnknown {
 public:
  virtual HRESULT AllocateBuffer(/* in */ uint32_t bufferSize,
...
/* Interface IDeckLinkAudioOutputCallback - Optional callback to allow audio
 * samples to be pulled as required. */
...
class IDeckLinkAPIInformation : public IUnknown {
 public:
  virtual HRESULT GetFlag(/* in */ BMDDeckLinkAPIInformationID cfgID,
                          /* out */ bool* value) = 0;
  virtual HRESULT GetInt(/* in */ BMDDeckLinkAPIInformationID cfgID,
                         /* out */ int64_t* value) = 0;
  virtual HRESULT GetFloat(/* in */ BMDDeckLinkAPIInformationID cfgID,
                           /* out */ double* value) = 0;
  virtual HRESULT GetString(/* in */ BMDDeckLinkAPIInformationID cfgID,
...
class IDeckLinkOutput : public IUnknown {
 public:
  ...
  virtual HRESULT GetDisplayModeIterator(
      /* out */ IDeckLinkDisplayModeIterator** iterator) = 0;

  virtual HRESULT SetScreenPreviewCallback(
      /* in */ IDeckLinkScreenPreviewCallback* previewCallback) = 0;

  /* Video Output */

  virtual HRESULT EnableVideoOutput(/* in */ BMDDisplayMode displayMode,
                                    /* in */ BMDVideoOutputFlags flags) = 0;
  virtual HRESULT DisableVideoOutput(void) = 0;

  virtual HRESULT SetVideoOutputFrameMemoryAllocator(
  ...
  virtual HRESULT CreateAncillaryData(
      /* in */ BMDPixelFormat pixelFormat,
      /* out */ IDeckLinkVideoFrameAncillary** outBuffer) = 0;

  virtual HRESULT DisplayVideoFrameSync(
  ...
  virtual HRESULT SetScheduledFrameCompletionCallback(
      /* in */ IDeckLinkVideoOutputCallback* theCallback) = 0;
  virtual HRESULT GetBufferedVideoFrameCount(
      /* out */ uint32_t* bufferedFrameCount) = 0;

  /* Audio Output */

  virtual HRESULT EnableAudioOutput(
  ...
  virtual HRESULT WriteAudioSamplesSync(
      /* in */ void* buffer,
  ...
  virtual HRESULT ScheduleAudioSamples(
      /* in */ void* buffer,
      /* in */ uint32_t sampleFrameCount,
  ...
  virtual HRESULT GetBufferedAudioSampleFrameCount(
      /* out */ uint32_t* bufferedSampleFrameCount) = 0;
  virtual HRESULT FlushBufferedAudioSamples(void) = 0;

  virtual HRESULT SetAudioCallback(
      /* in */ IDeckLinkAudioOutputCallback* theCallback) = 0;

  /* Output Control */

  virtual HRESULT StartScheduledPlayback(
      /* in */ BMDTimeValue playbackStartTime,
      /* in */ BMDTimeScale timeScale,
      /* in */ double playbackSpeed) = 0;
  virtual HRESULT StopScheduledPlayback(
  ...
  virtual HRESULT GetReferenceStatus(
      /* out */ BMDReferenceStatus* referenceStatus) = 0;

  /* Hardware Timing */

  virtual HRESULT GetHardwareReferenceClock(
  ...
  virtual HRESULT GetFrameCompletionReferenceTimestamp(
...
class IDeckLinkInput : public IUnknown {
 public:
  ...
  virtual HRESULT GetAvailableVideoFrameCount(
      /* out */ uint32_t* availableFrameCount) = 0;
  virtual HRESULT SetVideoInputFrameMemoryAllocator(
      /* in */ IDeckLinkMemoryAllocator* theAllocator) = 0;
  ...
  virtual HRESULT GetAvailableAudioSampleFrameCount(
...
class IDeckLinkEncoderInput : public IUnknown {
 public:
  ...
  virtual HRESULT EnableVideoInput(/* in */ BMDDisplayMode displayMode,
                                   ...
                                   /* in */ BMDVideoInputFlags flags) = 0;
  virtual HRESULT DisableVideoInput(void) = 0;
  virtual HRESULT GetAvailablePacketsCount(
      /* out */ uint32_t* availablePacketsCount) = 0;
  virtual HRESULT SetMemoryAllocator(
      /* in */ IDeckLinkMemoryAllocator* theAllocator) = 0;

  /* Audio Input */

  virtual HRESULT EnableAudioInput(/* in */ BMDAudioFormat audioFormat,
                                   /* in */ BMDAudioSampleRate sampleRate,
                                   /* in */ BMDAudioSampleType sampleType,
                                   /* in */ uint32_t channelCount) = 0;
  virtual HRESULT DisableAudioInput(void) = 0;
...
/* Interface IDeckLinkVideoFrame - Interface to encapsulate a video frame; can
 * be caller-implemented. */
...
/* Interface IDeckLinkMutableVideoFrame - Created by
...
class IDeckLinkMutableVideoFrame : public IDeckLinkVideoFrame {
 public:
  ...
  virtual HRESULT SetTimecode(/* in */ BMDTimecodeFormat format,
                              /* in */ IDeckLinkTimecode* timecode) = 0;
  virtual HRESULT SetTimecodeFromComponents(
  ...
  virtual HRESULT SetAncillaryData(
      /* in */ IDeckLinkVideoFrameAncillary* ancillary) = 0;
  virtual HRESULT SetTimecodeUserBits(
      /* in */ BMDTimecodeFormat format,
...
/* Interface IDeckLinkVideoFrame3DExtensions - Optional interface implemented on
 * IDeckLinkVideoFrame to support 3D frames */

class IDeckLinkVideoFrame3DExtensions : public IUnknown {
 public:
  virtual BMDVideo3DPackingFormat Get3DPackingFormat(void) = 0;
  virtual HRESULT GetFrameForRightEye(
...
/* Interface IDeckLinkVideoFrameMetadataExtensions - Optional interface
 * implemented on IDeckLinkVideoFrame to support frame metadata such as HDMI HDR
 * information */

class IDeckLinkVideoFrameMetadataExtensions : public IUnknown {
 public:
  virtual HRESULT GetInt(/* in */ BMDDeckLinkFrameMetadataID metadataID,
                         /* out */ int64_t* value) = 0;
  virtual HRESULT GetFloat(/* in */ BMDDeckLinkFrameMetadataID metadataID,
                           /* out */ double* value) = 0;
  virtual HRESULT GetFlag(/* in */ BMDDeckLinkFrameMetadataID metadataID,
                          /* out */ bool* value) = 0;
  virtual HRESULT GetString(/* in */ BMDDeckLinkFrameMetadataID metadataID,
                            /* out */ const char** value) = 0;
...
/* Interface IDeckLinkVideoInputFrame - Provided by the IDeckLinkVideoInput
...
class IDeckLinkVideoInputFrame : public IDeckLinkVideoFrame {
 public:
  virtual HRESULT GetStreamTime(/* out */ BMDTimeValue* frameTime,
                                ...
                                /* in */ BMDTimeScale timeScale) = 0;
  virtual HRESULT GetHardwareReferenceTimestamp(
      /* in */ BMDTimeScale timeScale,
...
/* Interface IDeckLinkVideoFrameAncillary - Obtained through QueryInterface() on
 * an IDeckLinkVideoFrame object. */

class IDeckLinkVideoFrameAncillary : public IUnknown {
 public:
  virtual HRESULT GetBufferForVerticalBlankingLine(/* in */ uint32_t lineNumber,
                                                   /* out */ void** buffer) = 0;
  virtual BMDPixelFormat GetPixelFormat(void) = 0;
...
/* Interface IDeckLinkEncoderPacket - Interface to encapsulate an encoded
 * packet. */
...
/* Interface IDeckLinkEncoderVideoPacket - Provided by the IDeckLinkEncoderInput
 * video packet arrival callback. */
...
/* Interface IDeckLinkEncoderAudioPacket - Provided by the IDeckLinkEncoderInput
 * audio packet arrival callback. */
...
/* Interface IDeckLinkH265NALPacket - Obtained through QueryInterface() on an
 * IDeckLinkEncoderVideoPacket object */
...
/* Interface IDeckLinkAudioInputPacket - Provided by the IDeckLinkInput
 * callback. */
...
class IDeckLinkAudioInputPacket : public IUnknown {
 public:
  ...
  virtual HRESULT GetBytes(/* out */ void** buffer) = 0;
  virtual HRESULT GetPacketTime(/* out */ BMDTimeValue* packetTime,
                                /* in */ BMDTimeScale timeScale) = 0;
...
class IDeckLinkGLScreenPreviewHelper : public IUnknown {
 public:
  ...
  virtual HRESULT Set3DPreviewFormat(
...
/* Interface IDeckLinkNotificationCallback - DeckLink Notification Callback
 * Interface */

class IDeckLinkNotificationCallback : public IUnknown {
 public:
  virtual HRESULT Notify(/* in */ BMDNotifications topic,
                         /* in */ uint64_t param1,
...
class IDeckLinkAttributes : public IUnknown {
 public:
  virtual HRESULT GetFlag(/* in */ BMDDeckLinkAttributeID cfgID,
                          /* out */ bool* value) = 0;
  virtual HRESULT GetInt(/* in */ BMDDeckLinkAttributeID cfgID,
                         /* out */ int64_t* value) = 0;
  virtual HRESULT GetFloat(/* in */ BMDDeckLinkAttributeID cfgID,
                           /* out */ double* value) = 0;
  virtual HRESULT GetString(/* in */ BMDDeckLinkAttributeID cfgID,
                            /* out */ const char** value) = 0;
...
class IDeckLinkStatus : public IUnknown {
 public:
  virtual HRESULT GetFlag(/* in */ BMDDeckLinkStatusID statusID,
                          /* out */ bool* value) = 0;
  virtual HRESULT GetInt(/* in */ BMDDeckLinkStatusID statusID,
                         /* out */ int64_t* value) = 0;
  virtual HRESULT GetFloat(/* in */ BMDDeckLinkStatusID statusID,
                           /* out */ double* value) = 0;
  virtual HRESULT GetString(/* in */ BMDDeckLinkStatusID statusID,
                            /* out */ const char** value) = 0;
  virtual HRESULT GetBytes(/* in */ BMDDeckLinkStatusID statusID,
                           /* out */ void* buffer,
                           /* in, out */ uint32_t* bufferSize) = 0;
...
/* Interface IDeckLinkDeviceNotificationCallback - DeckLink device
 * arrival/removal notification callbacks */
...
class IDeckLinkDiscovery : public IUnknown {
 public:
  virtual HRESULT InstallDeviceNotifications(
