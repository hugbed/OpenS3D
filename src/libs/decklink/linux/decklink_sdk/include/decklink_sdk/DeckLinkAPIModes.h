...
BMD_CONST REFIID IID_IDeckLinkDisplayModeIterator =
    /* 9C88499F-F601-4021-B80B-032E4EB41C35 */ {
        0x9C, 0x88, 0x49, 0x9F, 0xF6, 0x01, 0x40, 0x21,
        0xB8, 0x0B, 0x03, 0x2E, 0x4E, 0xB4, 0x1C, 0x35};
BMD_CONST REFIID IID_IDeckLinkDisplayMode =
    /* 3EB2C1AB-0A3D-4523-A3AD-F40D7FB14E78 */ {
        0x3E, 0xB2, 0xC1, 0xAB, 0x0A, 0x3D, 0x45, 0x23,
...
enum _BMDDisplayMode {
  ...
  bmdModeHD1080i6000 =
      /* 'Hi60' */ 0x48693630,  // N.B. This _really_ is 60.00 Hz.
  bmdModeHD1080p50 = /* 'Hp50' */ 0x48703530,
  bmdModeHD1080p5994 = /* 'Hp59' */ 0x48703539,
  bmdModeHD1080p6000 =
      /* 'Hp60' */ 0x48703630,  // N.B. This _really_ is 60.00 Hz.
...
enum _BMDPixelFormat {
  ...
  bmdFormat10BitRGB = /* 'r210' */ 0x72323130,     // Big-endian RGB 10-bit per
                                                   // component with SMPTE video
                                                   // levels (64-960). Packed as
                                                   // 2:10:10:10
  bmdFormat12BitRGB = /* 'R12B' */ 0x52313242,     // Big-endian RGB 12-bit per
                                                   // component with full range
                                                   // (0-4095). Packed as 12-bit
                                                   // per component
  bmdFormat12BitRGBLE = /* 'R12L' */ 0x5231324C,   // Little-endian RGB 12-bit
                                                   // per component with full
                                                   // range (0-4095). Packed as
                                                   // 12-bit per component
  bmdFormat10BitRGBXLE = /* 'R10l' */ 0x5231306C,  // Little-endian 10-bit RGB
                                                   // with SMPTE video levels
                                                   // (64-940)
  bmdFormat10BitRGBX = /* 'R10b' */ 0x52313062,    // Big-endian 10-bit RGB with
  // SMPTE video levels (64-940)
  bmdFormatH265 =
      /* 'hev1' */ 0x68657631  // High Efficiency Video Coding (HEVC/h.265)
};

/* Enum BMDDisplayModeFlags - Flags to describe the characteristics of an
