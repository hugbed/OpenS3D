...
typedef IDeckLinkGLScreenPreviewHelper_v7_6* (
    *CreateOpenGLScreenPreviewHelperFunc_v7_6)(void);
typedef IDeckLinkVideoConversion_v7_6* (
    *CreateVideoConversionInstanceFunc_v7_6)(void);
...
void InitDeckLinkAPI_v7_6(void) {
  ...
  gCreateIteratorFunc = (CreateIteratorFunc_v7_6)dlsym(
      libraryHandle, "CreateDeckLinkIteratorInstance");
  if (!gCreateIteratorFunc)
    fprintf(stderr, "%s\n", dlerror());
  gCreateVideoConversionFunc = (CreateVideoConversionInstanceFunc_v7_6)dlsym(
      libraryHandle, "CreateVideoConversionInstance");
...
void InitDeckLinkPreviewAPI_v7_6(void) {
  ...
  gCreateOpenGLPreviewFunc = (CreateOpenGLScreenPreviewHelperFunc_v7_6)dlsym(
      libraryHandle, "CreateOpenGLScreenPreviewHelper");
...
IDeckLinkGLScreenPreviewHelper_v7_6* CreateOpenGLScreenPreviewHelper_v7_6(
    void) {
  pthread_once(&gDeckLinkOnceControl, InitDeckLinkAPI_v7_6);
