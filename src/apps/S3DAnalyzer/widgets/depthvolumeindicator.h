#ifndef WIDGETS_DEPTHVOLUMEINDICATOR_H
#define WIDGETS_DEPTHVOLUMEINDICATOR_H
...
class DepthVolumeIndicator : public QWidget
{
    Q_OBJECT
public:
    explicit DepthVolumeIndicator(QWidget *parent = nullptr);
...
#endif // WIDGETS_DEPTHVOLUMEINDICATOR_H
